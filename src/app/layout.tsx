  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="fisioterapia-olarizu";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Fisioterapia &quot;Olarizu&quot;"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="fisioterapia-olarizu"
          data-primary-color="#77584a"
          defer
        ></script>
      </head>
